...
"""
__author__ = 'Evan Barnwell'

def print_gap():
    """
    This function prints a 'gap' to separate parts of the scorekeeper for readability
    """
    print('.')
    print('.')
    print('.')
...
def print_bar():
    """
    This function prints a 'bar' to separate parts of the scorekeeper for readability
    """
    print('------------------------------------------------------------------------')

def print_intro():
    """
    This function prints the introduction the the scorekeeper
    """
...
def get_holes():
    """
    This function gets the number of holes the user would like to score
    :return: Returns an amount of holes
    """
...
def make_holes_list(holes):
    """
    This function makes the holes into a list
    :param holes: Number of holes as an integer
    :return: Holes in a list
    """
...
def check_hole_count():
    """
    This function ensures the user entered a valid number of holes
    :return: Returns an amount of holes
    """
    print_gap()
    print('Please enter a number between 1 and 9: ')
...
def get_player_count():
    """
    This function gets the number of players the user would like to score
    :return: Returns an amount of players
    """
    print_gap()
...
def check_player_count():
    """
    This function ensures the user entered a valid number of players
    :return: Returns an amount of players
    """
    print_gap()
...
def get_player_names(players):
    ...
    :param players: The number of players as an integer
    :return: Returns the list of player names
    """
    print_gap()
...
def make_player_list(player_count, player_names):
    """
    This function creates a list of the players
    :param player_count: Number of players as an integer
...
def sort_players(player_list):
    """
    This function sorts players based on their score (second element of the tuple)
    :param player_list: List of players
    :return: Returns the player list sorted
    """
    sorted_list = sorted(player_list, key=lambda tup: tup[1])  # Sort taken from
    # https://stackoverflow.com/questions/10695139/sort-a-list-of-tuples-by-2nd-item-integer-value
    return sorted_list

def make_live_scoreboard(sorted_list):
    """
    This function prints a live scoreboard while the game is running
    :param sorted_list: The sorted player list
    """
...
def get_scores(holes, players, player_list, holes_list):
    """
    This function gets player scores
    :param holes: Number of holes as an integer
    :param players: Number of players as an integer
    :param player_list: Players in a list
    :param holes_list: Holes in a list
    :return: Returns the player list with their score on each hole
    """
    holes_played = 0
...
def make_final_list(players, player_list):
    """
    This function creates a final list once the game has finished
    :param players: Number of players as an integer
    :param player_list: Players in a list
    :return: Returns the player list with their scores summed
    """
    final_list = []
...
def make_scoreboard(sorted_list):
    """
    This function makes the final scoreboard displayed at the end of the game
    :param sorted_list: The player list sorted by score
    """
    places = ['1st', '2nd', '3rd', '4th']  # List of places to be entered in the live scoreboard
    print_gap()
    print('Scoreboard:')
...
def write_to_file(final_list, player_count):
    """
    This function writes to a text file where games are scored
    :param final_list: The sorted player list
    :param player_count: The number of players as an integer
    """
    bar = '---------------------------'
    n = '\n'
...
def play_again():
    """
    This function asks the user if it would like to play again
    :return: Returns boolean for whether or not the program will run again
    """
    print_gap()
    check = True
    again = True
...
def print_outro():
    """
      # This function prints the outro to the scorekeeper
    """
    print_gap()
    print('Goodbye!')
